...
def get_random_lesson():
    """Get a random lesson from the memory palace"""
    ...
    response = supabase_client.rpc('mp_search', {
        ...
        'similarity_threshold': -1.0,  # Very low threshold to account for different embedding models
        'match_count': 6
    }).execute()
    ...
    # Step 4: Generate a response using LiteLLM
